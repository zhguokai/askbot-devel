...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        """ignore copying the message data"""
        ...
        if db_table_exists('auth_message'):
    ...
    def backwards(self, orm):
        ...
        if not db_table_exists('auth_message'):
    ...
    models = {
        ...
        'askbot.groupmembership': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_membership'", 'to': u"orm['auth.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'group_membership'", 'to': u"orm['auth.User']"})
        },
        ...
        'askbot.userprofile': {
            ...
            'auth_user_ptr': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'askbot_profile'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['auth.User']"}),
