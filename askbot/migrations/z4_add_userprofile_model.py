...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'askbot_userprofile', (
            ('auth_user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(related_name='askbot_profile', unique=True, primary_key=True, to=orm['auth.User'])),
            ('avatar_urls', self.gf('jsonfield.fields.JSONField')(default={})),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'askbot_userprofile')
