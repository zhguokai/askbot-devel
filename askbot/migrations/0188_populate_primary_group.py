...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        gg_name = askbot_settings.GLOBAL_GROUP_NAME
        gg = orm['askbot.Group'].objects.filter(name=gg_name)
        if len(gg):
            global_group = gg[0]
        else:
            global_group = None
        ...
        count = users.count()
        message = 'Assigning primary group to users'

        for user in ProgressBar(users.iterator(), count, message):
            group = self.guess_primary_group(user, global_group, orm)
            if group:
                user.askbot_profile.primary_group = group
                user.askbot_profile.save()

    def backwards(self, orm):
        pass

    def guess_primary_group(self, user, global_group, orm):
        """returns user's primary group based
        on the logic used formerly, where
        first non-personal group where user 
        has full membership is assigned
        as primary"""

        groups = orm['askbot.Group'].objects.filter(
                    user=user
                )
        ...
        for group in groups:
            ...
            try:
                ...
                membership = orm['askbot.GroupMembership'].objects.get(**params)
            except orm['askbot.GroupMembership'].DoesNotExist:
                return None
    ...
    models = {
        ...
        'askbot.feed': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'askbot_feeds'", 'to': u"orm['sites.Site']"})
        },
        'askbot.feedtospace': {
            'Meta': {'unique_together': "(('space', 'feed'),)", 'object_name': 'FeedToSpace'},
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'space_links'", 'to': "orm['askbot.Feed']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'space': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'feed_links'", 'to': "orm['askbot.Space']"})
        },
        'askbot.group': {
        ...
        'askbot.groupmembership': {
            ...
            'requested_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'})
        },
        'askbot.grouptospace': {
            'Meta': {'unique_together': "(('space', 'group'),)", 'object_name': 'GroupToSpace'},
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['askbot.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'space': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['askbot.Space']"})
        },
        ...
        'askbot.space': {
            ...
            'questions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'spaces'", 'symmetrical': 'False', 'to': "orm['askbot.Thread']"})
        },
        'askbot.tag': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'askbot_tags'", 'symmetrical': 'False', 'to': u"orm['sites.Site']"}),
        ...
        'askbot.tagtosite': {
            'Meta': {'unique_together': "(('tag', 'site'),)", 'object_name': 'TagToSite'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'askbot_tag_links'", 'to': u"orm['sites.Site']"}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'askbot_site_links'", 'to': "orm['askbot.Tag']"}),
        ...
        'askbot.thread': {
            ...
            'followed_by': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'followed_threads'", 'blank': 'True', 'to': u"orm['auth.User']"}),
            ...
            'tagnames': ('django.db.models.fields.CharField', [], {'max_length': '125', 'blank': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'threads'", 'blank': 'True', 'to': "orm['askbot.Tag']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
        ...
        'askbot.userprofile': {
            ...
            'auth_user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'askbot_profile'", 'unique': 'True', 'to': u"orm['auth.User']"}),
            'default_site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'primary_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['askbot.Group']", 'null': 'True', 'blank': 'True'}),
            'subscribed_sites': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'subscriber_profile_set'", 'symmetrical': 'False', 'to': u"orm['sites.Site']"})
        },
        'askbot.vote': {
