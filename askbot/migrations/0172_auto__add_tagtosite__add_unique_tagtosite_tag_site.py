...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TagToSite'
        db.create_table('askbot_tagtosite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='askbot_site_links', to=orm['askbot.Tag'])),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='askbot_tag_links', to=orm['sites.Site'])),
            ('used_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('askbot', ['TagToSite'])

        # Adding unique constraint on 'TagToSite', fields ['tag', 'site']
        db.create_unique('askbot_tagtosite', ['tag_id', 'site_id'])

        # Adding M2M table for field sites on 'Tag'
        m2m_table_name = db.shorten_name(u'tag_sites')
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'TagToSite', fields ['tag', 'site']
        db.delete_unique('askbot_tagtosite', ['tag_id', 'site_id'])

        # Deleting model 'TagToSite'
        db.delete_table('askbot_tagtosite')

        # Removing M2M table for field sites on 'Tag'
        db.delete_table(db.shorten_name(u'tag_sites'))
