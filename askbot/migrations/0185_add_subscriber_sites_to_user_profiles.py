...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field subscribed_sites on 'UserProfile'
        m2m_table_name = db.shorten_name(u'askbot_userprofile_subscribed_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['askbot.userprofile'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'site_id'])

    def backwards(self, orm):
        # Removing M2M table for field subscribed_sites on 'UserProfile'
        db.delete_table(db.shorten_name(u'askbot_userprofile_subscribed_sites'))
