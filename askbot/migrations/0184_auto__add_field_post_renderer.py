...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.renderer'
        db.add_column('askbot_post', 'renderer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.renderer'
        db.delete_column('askbot_post', 'renderer')
    ...
    models = {
        ...
        'askbot.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_anonymous': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'language_code': ('django.db.models.fields.CharField', [], {'default': "'de'", 'max_length': '16'}),
            ...
            'renderer': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
