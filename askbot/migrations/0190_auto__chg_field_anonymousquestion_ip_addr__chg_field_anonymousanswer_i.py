...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'askbot_anonymousquestion', 'ip_addr', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))

        # Changing field 'AnonymousAnswer.ip_addr'
        db.alter_column(u'askbot_anonymousanswer', 'ip_addr', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))

        # Changing field 'PostRevision.ip_addr'
        db.alter_column(u'askbot_postrevision', 'ip_addr', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))

    def backwards(self, orm):

        # Changing field 'AnonymousQuestion.ip_addr'
        db.alter_column(u'askbot_anonymousquestion', 'ip_addr', self.gf('django.db.models.fields.IPAddressField')(max_length=15))

        # Changing field 'AnonymousAnswer.ip_addr'
        db.alter_column(u'askbot_anonymousanswer', 'ip_addr', self.gf('django.db.models.fields.IPAddressField')(max_length=15))

        # Changing field 'PostRevision.ip_addr'
        db.alter_column(u'askbot_postrevision', 'ip_addr', self.gf('django.db.models.fields.IPAddressField')(max_length=15))
