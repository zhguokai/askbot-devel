...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('askbot_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('auth_user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='askbot_profile', unique=True, to=orm['auth.User'])),
            ('default_site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
        ))
        db.send_create_signal('askbot', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('askbot_userprofile')
