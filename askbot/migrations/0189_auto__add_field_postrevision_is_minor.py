...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostRevision.is_minor'
        db.add_column('askbot_postrevision', 'is_minor',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostRevision.is_minor'
        db.delete_column('askbot_postrevision', 'is_minor')
