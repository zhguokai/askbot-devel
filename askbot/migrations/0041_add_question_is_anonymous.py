...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'question_revision', 'is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'AnonymousQuestion.is_anonymous'
        db.add_column('askbot_anonymousquestion', 'is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Question.is_anonymous'
        db.add_column(u'question', 'is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
