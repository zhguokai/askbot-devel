...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupMembership.requested_at'
        db.add_column('askbot_groupmembership', 'requested_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'GroupMembership.approved_at'
        db.add_column('askbot_groupmembership', 'approved_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupMembership.requested_at'
        db.delete_column('askbot_groupmembership', 'requested_at')

        # Deleting field 'GroupMembership.approved_at'
        db.delete_column('askbot_groupmembership', 'approved_at')
