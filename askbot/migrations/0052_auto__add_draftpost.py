...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DraftPost'
        db.create_table('askbot_draftpost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('body', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('tags', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('askbot', ['DraftPost'])


    def backwards(self, orm):
        
        # Deleting model 'DraftPost'
        db.delete_table('askbot_draftpost')
    ...
    models = {
        ...
        'askbot.draftpost': {
            'Meta': {'object_name': 'DraftPost'},
            'body': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tags': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
