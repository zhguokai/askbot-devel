...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.primary_group'
        db.add_column(u'askbot_userprofile', 'primary_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['askbot.Group'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.primary_group'
        db.delete_column(u'askbot_userprofile', 'primary_group_id')
