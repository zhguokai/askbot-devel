...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # TYPE_ACTIVITY_MODERATION_ALERT_SENT stays at 31
        # TYPE_ACTIVITY_POST_SHARED_WITH_SPACE moves from 31 to 33

        space_content_type = orm['contenttypes.ContentType'].objects.get(
            app_label='askbot',
            name='space')

        post_shared_activities = orm['askbot.Activity'].objects.filter(
            content_type=space_content_type,
            activity_type=31
        )

        for activity in post_shared_activities:
            activity.activity_type = const.TYPE_ACTIVITY_POST_SHARED_WITH_SPACE
            activity.save()
    ...
    models = {
        ...
        'askbot.feed': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'askbot_feeds'", 'to': "orm['sites.Site']"})
        },
        'askbot.feedtospace': {
        ...
        'askbot.tag': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'askbot_tags'", 'symmetrical': 'False', 'to': "orm['sites.Site']"}),
        ...
        'askbot.tagtosite': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'askbot_tag_links'", 'to': "orm['sites.Site']"}),
        ...
        'askbot.thread': {
            ...
            'followed_by': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'followed_threads'", 'blank': 'True', 'to': "orm['auth.User']"}),
