...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionWidget.site'
        db.add_column(u'askbot_questionwidget', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'AskWidget.site'
        db.add_column(u'askbot_askwidget', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionWidget.site'
        db.delete_column(u'askbot_questionwidget', 'site_id')

        # Deleting field 'AskWidget.site'
        db.delete_column(u'askbot_askwidget', 'site_id')
    ...
    models = {
        ...
        'askbot.postrevision': {
            ...
            'is_anonymous': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_minor': ('django.db.models.fields.NullBooleanField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
