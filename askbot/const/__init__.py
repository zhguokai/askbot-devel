...
# see more moderation related types at 60
TYPE_ACTIVITY_MODERATED_NEW_POST = 24 # new post placed on the queue
TYPE_ACTIVITY_MODERATED_POST_EDIT = 25 # post edit placed on the queue
...
TYPE_ACTIVITY_MODERATOR_UNFLAGGED_POST = 60
TYPE_ACTIVITY_MODERATOR_APPROVED_POST_REVISION = 61
TYPE_ACTIVITY_MODERATOR_APPROVED_USER = 62
TYPE_ACTIVITY_MODERATOR_DELETED_POST = 63
TYPE_ACTIVITY_MODERATOR_BLOCKED_IP = 64
TYPE_ACTIVITY_MODERATOR_BLOCKED_USER = 65
TYPE_ACTIVITY_MODERATOR_DELETED_USER_POSTS = 66
...
TYPE_ACTIVITY = (
    ...
    (TYPE_ACTIVITY_MODERATOR_UNFLAGGED_POST,
     _('moderator unflagged post')),
    (TYPE_ACTIVITY_MODERATOR_APPROVED_POST_REVISION,
     _('moderator approved post revision')),
    (TYPE_ACTIVITY_MODERATOR_DELETED_POST,
     _('moderator deleted post')),
    (TYPE_ACTIVITY_MODERATOR_BLOCKED_IP,
     _('moderator blocked IP address')),
    (TYPE_ACTIVITY_MODERATOR_BLOCKED_USER,
     _('moderator blocked user')),
    (TYPE_ACTIVITY_MODERATOR_DELETED_USER_POSTS,
     _('moderator deleted all user posts')),
)
