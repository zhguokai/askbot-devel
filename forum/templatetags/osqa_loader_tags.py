...
from utils.skins import get_template, find_template_source

#this file is copy-paste from Django templates/loader.py
#with some minor but important mods
...
register.tag('block_skin', do_block)
register.tag('extends_skin', do_extends)
register.tag('include_skin', do_include)
